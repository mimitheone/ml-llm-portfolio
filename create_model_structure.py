...
def main():
    ...
    parser.add_argument("model_name", help="Name of the model (e.g., 'ridge_regression')")
    parser.add_argument("--type", choices=["regression", "classification"], default="regression", 
