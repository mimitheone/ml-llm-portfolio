...
def main():
    ...
    print("\n🔧 To run the full CLI:")
    print(
        "   python -m src.cli train --model random_forest --task classification --config configs/classification/random_forest.yaml"
    )
    print(
        "   python -m src.cli evaluate --model random_forest --task classification --config configs/classification/random_forest.yaml"
    )
    print(
        "   python -m src.cli predict --model random_forest --task classification --config configs/classification/random_forest.yaml --input data/processed/inference.csv --output reports/predictions.csv"
    )
