...
class BankingReportAgent:
    ...
    def _analyze_risk_metrics(self, risk_kpis: Dict[str, float], 
    ...
    def _analyze_performance_metrics(self, perf_kpis: Dict[str, float], 
                                   market_context: Optional[str]) -> str:
    ...
    def _analyze_liquidity_metrics(self, liq_kpis: Dict[str, float], 
                                 market_context: Optional[str]) -> str:
    ...
    def _analyze_esg_metrics(self, esg_kpis: Dict[str, float], 
                            shap_summary: Optional[str], 
                            market_context: Optional[str]) -> str:
...
def analyze_metrics(kpis: Dict[str, float], 
                   shap_summary: Optional[str] = None,
                   market_context: Optional[str] = None,
                   **kwargs) -> str:
    """
