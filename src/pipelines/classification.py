...
def train_random_forest(cfg, algo_builder, model_dir):
    return _train(cfg, algo_builder, model_dir, task="classification")


def evaluate(cfg, model_path):
    return _evaluate(cfg, model_path, task="classification")
